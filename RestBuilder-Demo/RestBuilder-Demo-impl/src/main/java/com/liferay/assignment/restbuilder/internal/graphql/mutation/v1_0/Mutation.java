package com.liferay.assignment.restbuilder.internal.graphql.mutation.v1_0;
...
public class Mutation {
	...
	public Response deleteEntityBatch(
		...
		return _applyComponentServiceObjects(
			_entityResourceComponentServiceObjects,
			this::_populateResourceContext,
			entityResource -> entityResource.deleteEntityBatch(
				callbackURL, object));
	}
	...
	@GraphQLField
	public Response updateEntityBatch(
			@GraphQLName("callbackURL") String callbackURL,
			@GraphQLName("object") Object object)
		throws Exception {
		...
		return _applyComponentServiceObjects(
			_entityResourceComponentServiceObjects,
			this::_populateResourceContext,
			entityResource -> entityResource.putEntityBatch(
				callbackURL, object));
	}
	...
	@GraphQLField
	public Response createEntityBatch(
			@GraphQLName("callbackURL") String callbackURL,
			@GraphQLName("object") Object object)
		throws Exception {
		...
		return _applyComponentServiceObjects(
			_entityResourceComponentServiceObjects,
			this::_populateResourceContext,
			entityResource -> entityResource.postEntityBatch(
				callbackURL, object));
	}
