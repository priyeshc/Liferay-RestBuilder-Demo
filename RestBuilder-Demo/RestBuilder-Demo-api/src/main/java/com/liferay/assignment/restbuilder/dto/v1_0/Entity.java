package com.liferay.assignment.restbuilder.dto.v1_0;
 ...
 */
@Generated("")
@GraphQLName(description = "A very simple entity", value = "Entity")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "Entity")
public class Entity implements Serializable {

	public static Entity toDTO(String json) {
		return ObjectMapperUtil.readValue(Entity.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.liferay.assignment.restbuilder.dto.v1_0.Entity",
		name = "x-class-name"
	)
